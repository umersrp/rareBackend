...
const bookingCreateUpdateEmail = async (subject, contentHeading, contentPara, url, bookingProperty, property) => {
    try {
        ...
        const data123 = await transporter.sendMail({
            from: 'notification@rarehomes.ae',
            to: process.env.OWN_SERVER === "http://dev-rare.srp.ai" ? ["accounts@rarehomes.ae", "finance@rarehomes.ae" , 'saifahmedsrp@gmail.com'] : process.env.OWN_SERVER === "http://portals.rarehomesgroup.com/" ? ["accounts@rarehomes.ae", "finance@rarehomes.ae" , 'saifahmedsrp@gmail.com']  :   ["accounts@rarehomes.ae", "finance@rarehomes.ae" , 'saifahmedsrp@gmail.com'],
            subject: subject,
            html: htmlToSend,
            attachments: [
                {
