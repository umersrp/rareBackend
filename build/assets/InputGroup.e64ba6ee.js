import{r as A,b as a,j as e,aj as O,I as h}from"./index.50bb4499.js";const H=({type:l,label:N,placeholder:o,classLabel:j="form-label",className:i="",classGroup:B="",register:g,name:t,readonly:p,value:D,error:s,icon:E,disabled:u,id:c,horizontal:m,validate:n,isMask:x,msgTooltip:w,description:v,hasicon:G,onChange:d,merged:I,append:f,prepend:$,options:b,onFocus:y,...k})=>{const[r,S]=A.exports.useState(!1),q=()=>{S(!r)};return a("div",{className:`  ${m?"flex":""} 
