import{r as A,b as a,j as e,aj as O,I as h}from"./index.5e55c1ba.js";const H=({type:l,label:N,placeholder:o,classLabel:j="form-label",className:i="",classGroup:B="",register:g,name:t,readonly:p,value:D,error:s,icon:E,disabled:u,id:c,horizontal:m,validate:n,isMask:x,msgTooltip:w,description:v,hasicon:G,onChange:d,merged:I,append:f,prepend:$,options:b,onFocus:y,...k})=>{const[r,S]=A.exports.useState(!1),q=()=>{S(!r)};return a("div",{className:`  ${m?"flex":""} 
      ${I?"merged":""}  `,children:[N&&e("label",{htmlFor:c,className:`block capitalize ${j}  ${m?"flex-0 mr-6 md:w-[100px] w-[60px] break-words":""}`,children:N}),a("div",{className:`flex items-stretch inputGroup 
