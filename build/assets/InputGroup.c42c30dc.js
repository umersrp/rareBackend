import{r as A,c as a,j as e,al as O,I as h}from"./index.f5cdfd20.js";const H=({type:l,label:N,placeholder:o,classLabel:G="form-label",className:i="",classGroup:B="",register:g,name:t,readonly:p,value:D,error:s,icon:E,disabled:u,id:c,horizontal:m,validate:n,isMask:x,msgTooltip:w,description:v,hasicon:I,onChange:d,merged:j,append:f,prepend:$,options:b,onFocus:y,...k})=>{const[r,S]=A.exports.useState(!1),q=()=>{S(!r)};return a("div",{className:`  ${m?"flex":""} 
